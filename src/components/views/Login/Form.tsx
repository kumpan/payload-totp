...
//
// import type { LoginFieldProps } from './field.js'
//
...
// 	const collection = collectionConfig as ClientCollectionConfig
...
// 	}
//
// 	const handleLogin = (json: unknown) => {
// 		console.log('json')
// 		const data = json as UserWithToken
// 		setUser(data)
// 	}
//
// 	console.log('SearchParams in Form', searchParams)
// 	return (
// 		<Form
